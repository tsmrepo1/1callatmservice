...
<!-- Mirrored from laravel.spruko.com/admitro/Vertical-IconSidedar-Light/404 by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Nov 2021 07:34:32 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <div class="col-md-6">
                        <div class="">
                            <div class="text-white">
                                ...
                                <a class="btn btn-secondary" href="{{route('index')}}"><i class="fe fe-arrow-left-circle mr-1"></i>Back to Home</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 d-none d-md-flex align-items-center">
                        <img src="{{asset('public/admin')}}/assets/images/png/e1.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
