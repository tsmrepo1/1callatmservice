    ...
    <div class="container">
        <div class="row align-items-center flex-row-reverse">
            <div class="col-md-12 col-sm-12 text-center">
                Copyright © <?php echo date('Y'); ?> Designed by <a href="https://thinksurfmedia.com/" target="_blank">Thinksurf Media</a>. All rights reserved.
            </div>
        </div>
    </div>
</footer>
...
<!-- INTERNAL Prism js -->
<script src="{{asset('public/admin')}}/assets/plugins/prism/prism.js"></script>
...
<!-- INTERNAL File uploads js -->
<script src="{{asset('public/admin')}}/assets/plugins/fileupload/js/dropify.js"></script>
<script src="{{asset('public/admin')}}/assets/js/filupload.js"></script>
