...
<head>
    ...
    <!-- Title -->
    <title>Admin Panel | 1 Call ATM Service LLC</title>
    ...
    <link href="{{asset('public/admin')}}/assets/plugins/fancyuploder/fancy_fileupload.css" rel="stylesheet" />

    <!-- INTERNAL File Uploads css-->
    <link href="{{asset('public/admin')}}/assets/plugins/fileupload/css/fileupload.css" rel="stylesheet" type="text/css" />
