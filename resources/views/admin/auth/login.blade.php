...
<head>
    ...
    <!-- Title -->
    <title>Admin Login | 1 Call ATM Service LLC</title>

    <!--Favicon -->
    <link rel="icon" href="{{asset('public/admin')}}/assets/images/brand/logo_1.png" type="image/x-icon" />
                                    ...
                                    <div class="card p-4">
                                        <div class="card-body">
                                            <div class="text-center title-style mb-6">
                                                <img src="{{asset('public/admin/assets/images/brand/logo_1.png')}}" width="100px" class="img-fluid img-responsive mb-5">
