                                        ...
                                        <div class="col-md-12">
                                            <table id="example1" class="table table-bordered text-nowrap key-buttons">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" name="addmore[0][options]" value="{{$list}}" class="form-control" placeholder="Option">
                                                        </td>
                                                        <td>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#add").click(function() {
                    //console.log("ok");
                    ++i;
                    $("#example1").append('<tr><td><input type="text" name="addmore[' + i + '][options]" placeholder="Option" class="form-control" /></td><td><button type="button" class="btn btn-danger remove-tr"><i class="fa fa-trash"></i></button></td></tr>');
                });
